  ...
  return (
    <div className="flex w-full m-4 p-4 flex-col md:justify-center items-center gap-4 ">
      ...
      <span className="inline-block">
        <a href="https://drive.google.com/file/d/13mVPaDmQ7kH0yAasd1IMbCVXj7A6qpW-/view?usp=sharing" className="p-4 rounded flex gap-2 items-end">
          <MdDownload size={30} />
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <span className="purple-glass w-fit p-3">
          <Descriptional title="Quem eu sou?" description="Olá! Sou Eduardo, um estudante de Engenharia de Software no 
                        ...
                        e pelo desejo de dominar novas tecnologias. Fora das telas, um dos meus maiores hobbies é assistir MMA e levantamento de peso, que me ensinam
                        sobre disciplina e persistência."/>
        </span>
